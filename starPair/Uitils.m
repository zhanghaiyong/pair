...
//    HUD.margin = 10;
//    HUD.yOffset = -(SCREEN_HEIGHT/2)+90;
//    HUD.removeFromSuperViewOnHide = YES;
//    HUD.labelText = title;
//    [HUD show:YES];
//            
//            
//    [UIView animateWithDuration:1.3 delay:0 usingSpringWithDamping:1 initialSpringVelocity:5 options:UIViewAnimationOptionCurveEaseInOut animations:^{
//        HUD.transform = CGAffineTransformMakeTranslation(HUD.xOffset, HUD.yOffset+90);
//       
//    } completion:^(BOOL finished) {
////                HUD.yOffset = -(SCREEN_H/2)+90;
